...
class Settings:
    ...
    def from_env(cls) -> "Settings":
        ...
        return cls(
            ...
            memory_base_url=os.environ.get("MEMORY_BASE_URL", "http://127.0.0.1:3111"),
            ...
            memory_timeout_sec=float(os.environ.get("MEMORY_TIMEOUT_SEC", "10")),
            ...
            redmine_base_url=os.environ.get("REDMINE_BASE_URL") or None,
            redmine_api_key=os.environ.get("REDMINE_API_KEY") or None,
            redmine_timeout_sec=float(os.environ.get("REDMINE_TIMEOUT_SEC", "10")),
            ...
            gitlab_timeout_sec=float(os.environ.get("GITLAB_TIMEOUT_SEC", "10")),
            ...
            jenkins_base_url=os.environ.get("JENKINS_BASE_URL") or None,
            jenkins_user=os.environ.get("JENKINS_USER") or None,
            jenkins_token=os.environ.get("JENKINS_TOKEN") or None,
            jenkins_timeout_sec=float(os.environ.get("JENKINS_TIMEOUT_SEC", "10")),
